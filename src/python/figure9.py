"""
Figure 9: Human Hand Grip Capability vs Required Rope Diameters
...
plt.savefig('figures/figure9_grip_limits.png', dpi=600, bbox_inches='tight')
plt.savefig('figures/figure9_grip_limits.pdf', dpi=600, bbox_inches='tight')
print("Figure 9 saved: figures/figure9_grip_limits.png and .pdf")
plt.show()
